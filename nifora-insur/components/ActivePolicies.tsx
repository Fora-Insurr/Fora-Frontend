...
const policies = [
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        <path
          d="M14 7.5L10 3l-1.5 1.5L10 6H2v3h8l-1.5 1.5L10 12l4-4.5z"
          fill="#3b82f6"
        />
      </svg>
    ),
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        <rect
          ...
          strokeWidth="1.2"
        />
        <circle cx="8" cy="12" r="0.8" fill="#f59e0b" />
      </svg>
    ),
      ...
      {policies.map((p, i) => (
        <div
          ...
          style={{
            ...
            padding: "12px 20px",
            borderBottom:
              i < policies.length - 1 ? "1px solid #1a2535" : "none",
          }}
        >
          {/* Policy type */}
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p
                ...
                style={{ fontSize: "12px", color: "#e6edf3", lineHeight: 1.3 }}
              >
                {p.type}
              </p>
          ...
          <span
            ...
            style={{
              fontSize: "10px",
              color: p.statusColor || "#22c55e",
              backgroundColor: p.statusBg || "rgba(34,197,94,0.15)",
              height: "22px",
              width: "fit-content",
            }}
          >
            <span
              ...
              style={{
                width: "5px",
                height: "5px",
                backgroundColor: p.statusColor || "#22c55e",
                flexShrink: 0,
              }}
            />
            {p.status}
          ...
          <button
            style={{
              fontSize: "12px",
              color: p.actionCyan ? "#00d4c8" : "#8b9cb6",
              fontWeight: p.actionCyan ? 600 : 400,
            }}
